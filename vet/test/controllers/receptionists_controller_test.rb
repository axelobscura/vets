...
class ReceptionistsControllerTest < ActionController::TestCase
  ...
  test "should create receptionist" do
    assert_difference('Receptionist.count') do
      post :create, receptionist: { customer: @receptionist.customer, date: @receptionist.date, pet: @receptionist.pet, reason: @receptionist.reason, reminder: @receptionist.reminder, user_id: @receptionist.user_id }
    end
  ...
  test "should update receptionist" do
    patch :update, id: @receptionist, receptionist: { customer: @receptionist.customer, date: @receptionist.date, pet: @receptionist.pet, reason: @receptionist.reason, reminder: @receptionist.reminder, user_id: @receptionist.user_id }
    assert_redirected_to receptionist_path(assigns(:receptionist))
  end
